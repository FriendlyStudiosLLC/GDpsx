...
public partial class GDpsx_State_FPS_Sprint : GDpsx_State
{
    ...
    {
        StateMachine.PlayerMovement.CurrentSpeed = Mathf.Lerp(StateMachine.PlayerMovement.CurrentSpeed, StateMachine.PlayerMovement.SprintSpeed, 
