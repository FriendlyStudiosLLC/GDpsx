...
namespace GDpsx_Project.addons.GDpsx.Game.Scripts.First_Person.States
{
	public partial class GDpsx_State_FPS_Idle : GDpsx_State
	{
		...
		{
			StateMachine.PlayerMovement.CalculatedVelocity.X =
				Mathf.MoveToward(StateMachine.PlayerMovement.Velocity.X, 0, StateMachine.PlayerMovement.CurrentSpeed);
			StateMachine.PlayerMovement.CalculatedVelocity.Z =
				Mathf.MoveToward(StateMachine.PlayerMovement.Velocity.Z, 0, StateMachine.PlayerMovement.CurrentSpeed);
