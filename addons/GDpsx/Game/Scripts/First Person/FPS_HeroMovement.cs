...
namespace GDpsx_Project.addons.GDpsx.Game.Scripts.First_Person
{
	...
	{
		[ExportCategory("Camera Settings")] [Export]
		public Node3D Head;
		...
		public override void CalculateMovementVector(float delta)
		{
			...
			MovementDirection = MovementDirection.Lerp((Transform.Basis * new Vector3(InputDirection.X, 0f, InputDirection.Y)).Normalized(),
