...
using GDpsx_Project.addons.GDpsx.Game.Scripts.Inventory;
...
public partial class GDpsx_ItemEditor : Control
{
	...
	{
		GDpsx_Item _tempItem = new GDpsx_Item();
		...
		foreach (GDpsx_Item item in editor.gameBrain.Items)
		{
			int itemIndex = editor.gameBrain.Items.IndexOf(item);
	...
	public void UpdateBrain()
	{
		...
		{
			if (item == null) return;
			GDpsx_ItemButton button = itemButton.Instantiate() as GDpsx_ItemButton;
